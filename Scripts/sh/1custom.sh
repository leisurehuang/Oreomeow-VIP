...
dl_config_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/kiddin9/Oreomeow-VIP/main/Conf/Qinglong/config.sample.sh > $config_shell_path
...
dl_extra_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/kiddin9/Oreomeow-VIP/main/Tasks/qlrepo/extra.sh > $extra_shell_path
...
dl_code_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/kiddin9/Oreomeow-VIP/main/Scripts/sh/Helpcode2.8/code.sh > $code_shell_path
...
dl_task_before_shell() {
    ...
    curl -s --connect-timeout 3 https://raw.githubusercontent.com/kiddin9/Oreomeow-VIP/main/Scripts/sh/Helpcode2.8/task_before.sh > $task_before_shell_path
